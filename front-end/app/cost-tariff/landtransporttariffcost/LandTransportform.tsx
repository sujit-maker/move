    ...
    <DialogContent className="bg-white dark:bg-neutral-900 rounded-lg shadow-lg w-[700px] max-h-[90vh] overflow-y-auto border border-neutral-200 dark:border-neutral-800 p-0" onInteractOutside={e => e.preventDefault()}>
        ...
        <form className="px-6 pb-6 pt-2" onSubmit={handleSubmit}>
          ...
          <div className="flex justify-end gap-3 mt-8">
            <Button type="button" variant="outline" onClick={onClose} className="bg-neutral-800 text-white hover:bg-neutral-700 border border-neutral-700 cursor-pointer">
              Cancel
            </Button>
            <Button type="submit" className="bg-blue-700 text-white hover:bg-blue-800 font-semibold cursor-pointer">
